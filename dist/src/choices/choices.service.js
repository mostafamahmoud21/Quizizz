...
let ChoicesService = class ChoicesService {
    ...
    async createChoice(questionId, instructorId, createChoiceDto) {
    ...
    async updateChoice(choiceId, questionId, instructorId, updateChoiceDto) {
    ...
    async deleteChoice(choiceId, questionId, instructorId) {
        const choice = await this.PrismaService.choice.findUnique({
            where: { id: choiceId },
        });
        if (!choice)
